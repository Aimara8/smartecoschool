                ...
                <ul ref={slider}>
                    <li className='dot'>
                        <div className="slide">
                            ...
                            <ul id='use-case-ul'>
                            <p><b>Beneficios:</b></p>
                                <li className='use-case-li'><span>Ahorro del 25-40% en facturas de agua y electricidad.</span></li>
                                <li className='use-case-li'><span>Control remoto de dispositivos como luces y termostatos.</span></li>
                                <li className='use-case-li'><span>Alertas en caso de fugas de agua o uso excesivo.</span></li>
                            </ul>
                        </div>
                    </li>
                    <li className='dot'>
                        <div className="slide">
                            ...
                            <ul id='use-case-ul'>
                            <p><b>Beneficios:</b></p>
                                <li className='use-case-li'><span>Reducción del 30-50% en costos de energía y agua.</span></li>
                                <li className='use-case-li'><span>Automatización del control de iluminación y climatización según la ocupación.</span></li>
                                <li className='use-case-li'><span>Monitoreo en tiempo real con alertas de fugas de agua o uso anómalo de energía.</span></li>
                            </ul>
                        </div>
                    </li>
                    <li className='dot'>
                        <div className="slide">
                            ...
                            <ul id='use-case-ul'>
                            <p><b>Beneficios:</b></p>
                                <li className='use-case-li'><span>Ahorro de hasta un 40% en el consumo de agua gracias al riego inteligente adaptado a las condiciones climáticas.</span></li>
                                <li className='use-case-li'><span>Reducción significativa de costos en iluminación pública, al ajustar automáticamente la intensidad lumínica.</span></li>
                                <li className='use-case-li'><span>Mejora de la seguridad ciudadana mediante la activación de luces en respuesta a la presencia de personas en zonas específicas.</span></li>
                            </ul>
                        </div>
                    </li>
                </ul>
